...
# 1. 환경 설정
PROJECT_DIR="/var/jenkins_home/workspace/moeego_server"    # 실제 Spring Boot 프로젝트 경로
YML_SOURCE="/var/jenkins_home/workspace/moeego_server/src/main/resources/application.yml" # .yml 파일의 실제 경로
