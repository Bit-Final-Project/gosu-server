...
public class ImageDTO {
    ...
    private Long proArticleNo;    // 프로 게시판 글 번호 
    ...
    public ImageDTO(Long imageNo, Long reviewNo, Long proArticleNo, Long articleNo, Long memberNo, 
                    String imageName, String imageUuidName) {
        this.imageNo = imageNo;
        this.reviewNo = reviewNo;
        this.proArticleNo = proArticleNo;
